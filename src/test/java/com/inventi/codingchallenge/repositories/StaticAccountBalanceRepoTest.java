...
class StaticAccountBalanceRepoTest {
    ...
    void  shouldReturnNoneIfTheDateFromDoesNotMatch() {
        StaticAccountBalanceRepo repo = new StaticAccountBalanceRepo();
        StaticCache.BankOperations.add(new BankOperation("1", null, LocalDateTime.of(2020, 1, 1, 0, 0), null, null, null));
    ...
    void  shouldReturnBetweenDates() {
        StaticAccountBalanceRepo repo = new StaticAccountBalanceRepo();
        StaticCache.BankOperations.add(new BankOperation("1", null, LocalDateTime.of(2020, 1, 1, 0, 0), null, null, null));
        StaticCache.BankOperations.add(new BankOperation("1", null, LocalDateTime.of(2020, 6, 1, 0, 0), null, null, null));
        StaticCache.BankOperations.add(new BankOperation("1", null, LocalDateTime.of(2020, 11, 1, 0, 0), null, null, null));
    ...
    void  shouldReturnMultipleBetweenDates() {
        ...
        StaticCache.BankOperations.add(new BankOperation("1", null, LocalDateTime.of(2020, 1, 1, 0, 0), null, null, null));
        StaticCache.BankOperations.add(new BankOperation("1", null, LocalDateTime.of(2020, 6, 1, 0, 0), null, null, null));
        StaticCache.BankOperations.add(new BankOperation("1", null, LocalDateTime.of(2020, 7, 1, 0, 0), null, null, null));
        StaticCache.BankOperations.add(new BankOperation("1", null, LocalDateTime.of(2020, 11, 1, 0, 0), null, null, null));
    ...
    void  shouldReturnFromMultipleAccounts() {
        StaticAccountBalanceRepo repo = new StaticAccountBalanceRepo();
        StaticCache.BankOperations.add(new BankOperation("1", null, LocalDateTime.of(2020, 1, 1, 0, 0), null, null, null));
        StaticCache.BankOperations.add(new BankOperation("2", null, LocalDateTime.of(2020, 6, 1, 0, 0), null, null, null));
        StaticCache.BankOperations.add(new BankOperation("1", null, LocalDateTime.of(2020, 11, 1, 0, 0), null, null, null));
